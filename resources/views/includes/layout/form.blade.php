    ...
    <div class="d-flex row justify-content-between">
        ...
        <div class="mb-3 text-start col-2">
            ...
            <input type="text" id="toponymic" name="toponymic"
                ...
                value="{{ old('toponymic', $estate->Toponymic) }}" min="1" max="254" required>
            @error('toponymic')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3 text-start col-3">
            ...
            <input type="text" id="street_name" name="street_name"
                ...
                value="{{ old('street_name', $estate->street_name) }}" min="1" max="254" required>
            @error('street_name')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3 text-start col-1">
            ...
            <input type="number" id="number" name="number"
                ...
                value="{{ old('number', $estate->number) }}" min="1" max="254" required>
            @error('number')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3 text-start col-1">
            ...
            <input type="number" id="zip_code" name="zip_code"
                ...
                value="{{ old('zip_code', $estate->zip_code) }}" maxlength="5" minlength="5" required>
            @error('zip_code')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3 text-start col-3">
            ...
            <input type="text" id="city" name="city"
                ...
                value="{{ old('city', $estate->city) }}" min="0.01" step="0.01" required>
            @error('city')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
